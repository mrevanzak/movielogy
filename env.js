 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.movielogy.staging
 */
...
const EAS_PROJECT_ID = '54b0dced-388c-4722-bf76-896fef4b1fd5'; // eas project id
const SCHEME = 'movielogy'; // app scheme
